...
<nav class="flex-1 overflow-y-auto sidebar-scroll py-6 px-4 space-y-1 z-10">
    ...
    <a href="{{ route('admin.hot-deal-promos.index') }}" class="flex items-center px-4 py-3 rounded-xl group transition-all duration-200 {{ request()->routeIs('admin.hot-deal-promos.*') ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('admin.hot-deal-promos.*') ? 'opacity-100' : 'opacity-70 group-hover:opacity-100' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3"></path></svg>
        <span class="font-medium text-sm">Hot Deal Promos</span>
    </a>

    <a href="{{ route('admin.marquee-images.index') }}" class="flex items-center px-4 py-3 rounded-xl group transition-all duration-200 {{ request()->routeIs('admin.marquee-images.*') ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('admin.marquee-images.*') ? 'opacity-100' : 'opacity-70 group-hover:opacity-100' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
        <span class="font-medium text-sm">Homepage Marquee</span>
    </a>
    ...
    <a href="{{ route('admin.popular-searches.index') }}" class="flex items-center px-4 py-3 rounded-xl group transition-all duration-200 {{ request()->routeIs('admin.popular-searches.*') ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('admin.popular-searches.*') ? 'opacity-100' : 'opacity-70 group-hover:opacity-100' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
        <span class="font-medium text-sm">Popular Searches</span>
    </a>
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <header class="h-20 bg-white/70 dark:bg-slate-900/80 backdrop-blur-lg border-b border-slate-200/60 dark:border-slate-800/80 flex items-center justify-between px-4 md:px-8 z-20 sticky top-0 transition-colors duration-300">
            ...
            <div class="flex items-center text-sm font-medium text-slate-500">
                ...
                <div class="hidden sm:flex items-center px-4 py-2 bg-slate-100/80 dark:bg-slate-800/80 rounded-xl">
